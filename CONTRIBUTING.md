...
4. Run the Worker with `npm run dev -w @built-by-chat/web -- --host` and the chosen Cloudflare local workflow documented in [operations](docs/launch/OPERATIONS.md).
