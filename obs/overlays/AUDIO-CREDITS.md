...
- Intro: `/overlays/intro.html?audio=1&volume=.22&episode=Episode%2001%20%C2%B7%20Founding%20Day`
- Outro: `/overlays/outro.html?audio=1&volume=.18&duration=18&event=Sunday%20Playtest%20%2B%20Town%20Hall&date=Sunday%20%C2%B7%203%3A00%20PM%20CT`
- Add `motion=reduced` for a static, reduced-motion presentation.
- For local browser review, click the audio notice or press `M` if autoplay is blocked. OBS Browser Sources normally permit media playback; keep “Control audio via OBS” enabled so the music is metered and recorded on the intended track.
